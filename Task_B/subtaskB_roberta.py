...
def main():
    ...
    model.save_weights('./Model/roberta/roberta_weights')

    # model.load_weights('./Model/roberta/roberta_weights')
    ...
    subtaskB_pred_answers.to_csv('./Data/subtaskB_pred_roberta_answers.csv', index=False)
