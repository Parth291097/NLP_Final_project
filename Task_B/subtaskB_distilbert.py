...
def main():
    ...
    model.save_weights('./Model/distilbert/distilbert_weights')

    # model.load_weights('./Model/distilbert/distilbert_weights')
    ...
    subtaskB_pred_answers.to_csv('./Data/subtaskB_pred_distilbert_answers.csv', index=False)
