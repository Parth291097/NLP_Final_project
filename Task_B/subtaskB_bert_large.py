...
def main():
    ...
    model.save_weights('./Model/bert_large/bert_large_weights')

    # model.load_weights('./Model/bert_large/bert_large_weights')
    ...
    subtaskB_pred_answers.to_csv('./Data/subtaskB_pred_bert_large_answers.csv', index=False)
