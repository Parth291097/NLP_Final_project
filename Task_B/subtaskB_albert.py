...
def main():
    ...
    model.save_weights('./Model/albert/albert_weights')

    # model.load_weights('./Model/albert/albert_weights')
    ...
    subtaskB_pred_answers.to_csv('./Data/subtaskB_pred_albert_answers.csv', index=False)
